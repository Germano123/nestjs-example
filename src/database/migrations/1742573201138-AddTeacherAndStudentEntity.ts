...
export class AddTeacherAndStudentEntity1742573201138 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "profile" ADD "role" character varying NOT NULL DEFAULT 'Blank'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "profile" DROP COLUMN "role"`);
    }
